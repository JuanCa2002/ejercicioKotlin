...
class Customer {
    ...
    fun calculateBalanceCheckAccounts(): Double {
        val cuentasCorrientes= accounts.filter { it.typeEnum== TypeAccountEnum.CHECK }
        return cuentasCorrientes.sumOf { it.balance }
    }
    ...
    fun calculateBalanceSavingAccounts(): Double {
        val cuentasAhorros= accounts.filter { it.typeEnum== TypeAccountEnum.SAVE }
        return cuentasAhorros.sumOf { it.balance }
    }
